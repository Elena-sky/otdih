...
@section('content')
    ...
    <div class="wrapper row3">
        <main class="hoc container clear">
            ...
            <div class="center btmspace-80">
                <p>Наше месторасположение позволяет отдохнуть от суеты города в зеленой зоне частных домов, а также удобно, без пересадок добраться до центра города, на привоз, на вокзал и т.д.
                </p>
